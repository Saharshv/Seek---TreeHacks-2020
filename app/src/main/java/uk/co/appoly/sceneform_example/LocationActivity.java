...
public class LocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ArrayList<Double> listFromDatabase;

        //Retrieving data from database
        DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
        DatabaseReference chatSpaceRef = rootRef.child("users");
        ValueEventListener eventListener = new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    ArrayList<Double> msg = (ArrayList<Double>) ds.getValue();
                    Log.d("TAG", "blah" + msg);
        ...
        //Getting phone's location or last known location
                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                            ...
                            list.add(phoneLocation.getLongitude());
                            list.add(phoneLocation.getLatitude());
                            myRef.child(username).setValue(list);
                        }
                    }
                });
